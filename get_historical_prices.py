...
request_params = StockBarsRequest(
    ...
    limit=100000,
    feed="iex"  # Use "iex" for IEX Cloud data feed
...
# file_name = "/Users/jerzy/Develop/MachineTrader/Internship_Summer_2025/data/price_bars_" + current_time.strftime(
#     "%Y%m%d") + ".csv"
file_name = "price_bars_" + current_time.strftime("%Y%m%d") + ".csv"
price_bars.to_csv(file_name, index=False)
print(
    "Finished getting historical OHLCV stock prices and saved to price_bars.csv"
)
