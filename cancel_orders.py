...
if (len(orders) > 0):
    ...
    for order in orders:
        ...
        cancelled_orders.loc[len(cancelled_orders)] = [
            date_now, time_stamp, order_id
        ]
    ...
    file_name = "/Users/jerzy/Develop/MachineTrader/Internship_Summer_2025/data/cancelled_orders_" + current_time.strftime(
        "%Y%m%d") + ".csv"
